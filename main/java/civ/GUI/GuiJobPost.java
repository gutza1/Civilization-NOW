...
public class GuiJobPost extends GuiContainer
{
	//Static Functions
    public static void DisplayGUIJobPost_ForPlayer_FromServer(EntityPlayerMP player, IInventory inventory, int posX, int posY, int posZ)
    {
        ...
        player.openContainer = new ContainerJobPost(player.inventory, inventory);
        player.openContainer.windowId = player.currentWindowId;
        player.openContainer.addCraftingToCrafters(player);        

        player.openGui(CivMod.instance, 1, player.worldObj, posX, posY, posZ);
    }
    
    //Private Fields
    //private static final ResourceLocation field_147017_u = new ResourceLocation("textures/gui/container/generic_54.png");
    private static final ResourceLocation field_147017_u = new ResourceLocation("civmod", "/textures/gui/job_post_gui.png");
    ...
    public GuiJobPost(IInventory par1IInventory, IInventory par2IInventory)
    {
        super(new ContainerJobPost(par1IInventory, par2IInventory));
