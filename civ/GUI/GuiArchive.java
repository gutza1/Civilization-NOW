...
{
	//Static Functions
    public static void DisplayGUIArchive_ForPlayer_FromServer(EntityPlayerMP player, IInventory inventory, int posX, int posY, int posZ)
    {
        ...
        player.openGui(CivMod.instance, 2, player.worldObj, posX, posY, posZ);
    }
    ...
    public GuiArchive(IInventory par1IInventory, IInventory par2IInventory)
    {
