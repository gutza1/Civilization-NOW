...
public class EntityCivHorse extends EntityHorse
{
    private static final IEntitySelector horseBreedingSelector = new IEntitySelector()
    {
        ...
        {
            return par1Entity instanceof EntityCivHorse && ((EntityCivHorse)par1Entity).func_110205_ce();
        }
    };
    ...
    public EntityCivHorse(World par1World)
    {
        super(par1World);
    ...
    protected EntityCivHorse getClosestHorse(Entity par1Entity, double par2)
    {
    ...
    public void onLivingUpdate()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                EntityCivHorse CivHorse = this.getClosestHorse(this, 16.0D);

                if (CivHorse != null && this.getDistanceSqToEntity(CivHorse) > 4.0D)
                {
                    PathEntity pathentity = this.worldObj.getPathEntityToEntity(this, CivHorse, 16.0F, true, false, false, true);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        {
            EntityCivHorse CivHorse = (EntityCivHorse)par1EntityAnimal;

            if (this.func_110200_cJ() && CivHorse.func_110200_cJ())
            {
                int i = this.getHorseType();
                int j = CivHorse.getHorseType();
    ...
    {
        EntityCivHorse CivHorse = (EntityCivHorse)par1EntityAgeable;
        EntityCivHorse CivHorse1 = new EntityCivHorse(this.worldObj);
        int i = this.getHorseType();
        int j = CivHorse.getHorseType();
        int k = 0;
        ...
        if (k == 0)
        {
            ...
            {
                l = CivHorse.getHorseVariant() & 255;
            }
            else
            {
            ...
            {
                l |= CivHorse.getHorseVariant() & 65280;
            }
            else
            {
            ...
            CivHorse1.setHorseVariant(l);
        }

        CivHorse1.setHorseType(k);
        ...
        CivHorse1.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(d1 / 3.0D);
        ...
        CivHorse1.getEntityAttribute(horseJumpStrength).setBaseValue(d2 / 3.0D);
        ...
        CivHorse1.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(d0 / 3.0D);
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData par1EntityLivingData)
    {
        ...
        if (p_110161_1_1 instanceof EntityCivHorse.GroupData)
        {
            l = ((EntityCivHorse.GroupData)p_110161_1_1).field_111107_a;
            i = ((EntityCivHorse.GroupData)p_110161_1_1).field_111106_b & 255 | this.rand.nextInt(5) << 8;
        }
        else
        {
            ...
            p_110161_1_1 = new EntityCivHorse.GroupData(l, i);
        }
